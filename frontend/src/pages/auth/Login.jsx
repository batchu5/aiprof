      ...
      <div className="lg:w-1/2 flex items-center justify-center p-6 sm:p-12 bg-slate-50 relative">
        <div className="w-full max-w-md space-y-8">
          <div className="text-center lg:text-left">
            ...
            <p className="text-slate-500 text-sm mt-2">Welcome back! Please enter your credentials.</p>
          </div>
          ...
          <div className="bg-white/60 border border-slate-200 rounded-3xl p-8 shadow-2xl backdrop-blur-md">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-11 pr-4 py-3.5 bg-white border border-slate-200/80 rounded-xl text-slate-900 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all text-sm"
                  />
                </div>
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    placeholder="••••••••"
                    className="w-full pl-11 pr-11 py-3.5 bg-white border border-slate-200/80 rounded-xl text-slate-900 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 transition-all text-sm"
                  />
                  <button
                    type="button"
              ...
              <Button
                ...
                variant="primary"
                isLoading={loading}
                className="w-full py-3.5 font-semibold text-sm flex items-center justify-center gap-2 group shadow-lg shadow-blue-600/20"
              >
                Sign In
