    ...
    if (this.state.hasError) {
      return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-6 text-center">
          <div className="bg-slate-900/90 border border-slate-800 p-8 rounded-2xl max-w-lg w-full shadow-2xl backdrop-blur-xl">
            ...
            {this.state.error && (
              <div className="mt-4 text-left">
                ...
                {this.state.showDetails && (
                  <div className="mt-3 p-3 rounded-xl bg-slate-950 border border-slate-800 text-xs text-red-300 font-mono overflow-x-auto max-h-40">
